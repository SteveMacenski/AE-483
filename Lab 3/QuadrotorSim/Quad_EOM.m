...
f(7) = (1/c2)*(s3*x(11) + c3*x(10));
f(8) = (1/c2)*(c2*c3*x(11) + -c2*s3*x(10));
f(9) = (1/c2)*(c2*x(12) + s2*s3*x(11) + s2*c3*x(10));
 

% omegadot = omega, Js, other stuffz
f(10) = 1/J1 * (u(1) + (J2 - J3)*x(11)*x(10));
f(11) = 1/J2 * (u(2) + (J3 - J1)*x(12)*x(10));
f(12) = 1/J3 * (u(3) + (J1 - J2)*x(12)*x(11));
